...
void MKLDNNMVNNode::createPrimitive() {
    ...
    if (!dstMemPtr || !dstMemPtr->GetPrimitivePtr())
        THROW_IE_EXCEPTION << "MVN layer with name '" << getCnnLayer()->name << "' didn't allocate destination memory.";
    if (getSelectedPrimitiveDescriptor() == nullptr)
        THROW_IE_EXCEPTION << "MVN layer with name '" << getCnnLayer()->name << "' didn't set preferable primitive descriptor.";
